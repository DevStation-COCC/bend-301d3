...
function displayPics(){
  ...
  // The error arose because the variable rando was declared with let and therefore is locally scoped to the first while loop  in displayPics and the console.log sits outside that code block.
