...
// Because arrow functions have the scope of the object above them and when there is no closest scope it goes all the way to the top to the window object
